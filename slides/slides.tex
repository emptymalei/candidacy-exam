...
\subsection{Why Do Neutrino Oscillate}
...
\begin{equation*}
    P_{\mathrm{L\to H}}^{(n)} = \frac{ \left\lvert \left\lvert \hat B_{n} \right\rvert/2 \right\rvert^2 }{ \left\lvert  \left\lvert \hat B_{n} \right\rvert/2 \right\rvert^2 + ( n \hat k - 1 )^2  } \sin^2 \left( \frac{ q^{(n)} }{2} x \right)  ,
\end{equation*}
