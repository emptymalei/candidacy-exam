...
Neutrino wave function in flavor basis $(\ket{\nu_{\mathrm e}}, \ket{\nu_{\mathrm x}})^T$ is related to state in energy eigenbasis $(\ket{\nu_1},\ket{\nu_2})^T$ through

\begin{equation*}
\begin{pmatrix}\ket{\nu_{\mathrm e}} \\ \ket{\nu_{\mathrm x} } \end{pmatrix} = \begin{pmatrix}  \cos\theta  & \sin\theta \\ -\sin\theta  & \cos\theta \end{pmatrix}   \begin{pmatrix}\ket{\nu_1} \\ \ket{\nu_2}\end{pmatrix}
\end{equation*}
...
\begin{align*}
&\frac{\omega_{\mathrm v} }{2}\begin{pmatrix} -\cos 2\theta_v & \sin 2 \theta_v \\ \sin 2\theta_v & \cos 2\theta_v  \end{pmatrix} \\
=&
\frac{\omega_{\mathrm v} }{2}\left( - \cos 2\theta_v\boldsymbol{ \sigma_3 } + \sin 2\theta_v \boldsymbol{\sigma_1} \right)
\end{align*}
...
\begin{equation*}
P(\ket{\nu_{\mathrm e} }\to\ket{\nu_{\mathrm x}})  =  \sin^2(2\theta_{\mathrm v}) \frac{ 1- \cos \left( \omega_{\mathrm v} x \right) }{2}
\end{equation*}
...
\begin{equation*}
    \mathbf{H} = \frac{  {\color{red}\omega_m(x) }    {\color{blue}\cos 2\theta_m(x)}  }{2} \boldsymbol{\sigma_3} + \frac{ {\color{red}\omega_m(x) }   {\color{blue}\sin 2\theta_m(x) } }{2} \boldsymbol{\sigma_1},
\end{equation*}
...
\begin{align*}
    ...
    {\color{blue}\tan 2\theta_m(x)} = & ~\frac{\sin 2\theta_v}{\left(\cos 2\theta_v - \frac{\lambda(x)}{\omega_v} \right)}.
\end{align*}
\end{tcolorbox}

\begin{tcolorbox}[title=Significance of $\theta_m$]
...
\caption*{Stimulated oscillation. $\delta \lambda(x) = A \sin (\hat k \hat x)$  with $\hat A=0.1$, $\hat k=0.995$, $\theta_m=\pi/6$}
\end{figure}
...
\begin{equation*}
    \mathbf{\widetilde H} = - \frac{ {\color{red}\delta \lambda(x)}  }{2} \sin 2\theta_m \begin{pmatrix} 0 & e^{2i\eta(x)} \\ e^{-2 i\eta(x) } & 0 \end{pmatrix} 
\end{equation*} 
