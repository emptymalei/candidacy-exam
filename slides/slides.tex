...
1978 \& 1985 & Wolfenstein--Mikheyev--Smirnov (MSW) effect \endlr
...
\begin{figure}
    ...
    \caption*{Probabilities of finding neutrinos to be in each flavors. Neutrino energy: 1MeV}
\end{figure}
...
\begin{equation*}
i\partial_{\mathrm x} \ket{\Psi} = \hat {\mathbf H} \ket{\Psi}
\end{equation*}
...
\begin{equation*}
P(\ket{\nu_{\mathrm e} }\to\ket{\nu_{\mu}})  =  \sin^2(2\theta_{\mathrm v}) \sin \left( \omega_{\mathrm v} x/2 \right) 
\end{equation*}
\alert{Mixing angle $\to$ Flavor oscillation amplitude\\
$(m_2^2-m_1^2)/2E$ $\to$ Oscillation wavelength}
...
\begin{itemize}
    ...
    \item Matter interaction
        \tikz[na]\node [coordinate] (n3) {};
    \item<4-> $\lambda(x) = \sqrt{2}G_{\mathrm{F}} n_{\mathrm{e}}(x)$ 
\end{itemize}
...
\begin{equation*}
    \mathbf{H} = \frac{\omega_{\mathrm{v}} \cos 2\theta_{\mathrm{v}} }{2} \boldsymbol{\sigma_3} + \frac{ \omega_{\mathrm{v}} \sin 2\theta_{\mathrm{v}}}{2} \boldsymbol{\sigma_1}
\end{equation*}
...
\begin{equation*}
    \mathbf{H} = \frac{  {\color{red}\omega_{\mathrm{m}}(x) }    {\color{blue}\cos 2\theta_{\mathrm{m}}(x)}  }{2} \boldsymbol{\sigma_3} + \frac{ {\color{red}\omega_{\mathrm{m}}(x) }   {\color{blue}\sin 2\theta_{\mathrm{m}}(x) } }{2} \boldsymbol{\sigma_1},
\end{equation*}

where

\begin{align*}
    {\color{red}\omega_{\mathrm{m}}(x) } = & ~\omega_{\mathrm{v}}\sqrt{ \left(\frac{\lambda}{\omega_{\mathrm{v}}} - \cos 2\theta_{\mathrm{v}} \right)^2 + \sin^2 2\theta_{\mathrm{v}}  }  ,\\
    {\color{blue}\tan 2\theta_{\mathrm{m}}(x)} = & ~\frac{\sin 2\theta_{\mathrm{v}}}{\left(\cos 2\theta_{\mathrm{v}} - \frac{\lambda(x)}{\omega_{\mathrm{v}}} \right)}.
\end{align*}
\end{tcolorbox}
...
\begin{equation*}
P(\ket{\nu_{\mathrm{e}}}\to\ket{\nu_x})  = \frac{1}{2} {\color{blue}\sin^2(2\theta_{\mathrm{m}})} \left[ 1- \cos \left( {\color{red}\omega_{\mathrm{m}}} x \right) \right]
\end{equation*}
...
\begin{align*}
    {\color{red}\omega_{\mathrm{m}}(x) } =& \omega_{\mathrm{v}}\sqrt{ \left(\frac{\lambda}{\omega_{\mathrm{v}}} - \cos 2\theta_{\mathrm{v}} \right)^2 + \sin^2 2\theta_{\mathrm{v}}  }  ,\\
    {\color{blue}\tan 2\theta_{\mathrm{m}}(x)} = & \sin 2\theta_{\mathrm{v}} /\left(\cos 2\theta_{\mathrm{v}} - \frac{\lambda(x)}{\omega_{\mathrm{v}}} \right)  .
\end{align*}
}
...
\begin{itemize}
    ...
    \begin{equation*}
        l_{\mathrm v}, \quad l_{\mathrm m} \sim \frac{1}{\lambda_0} 
    \end{equation*}
    
    \item Varying matter profile $\lambda(x) = \lambda_0 + A \sin (k x)$,
    
    \begin{equation*}
        l_{\mathrm v}, \quad l_{\mathrm m}, \quad l_{\mathrm k} \sim \frac{1}{k}
    \end{equation*}
\end{itemize}
...
\begin{equation*}
    l_{\mathrm v} \sim l_{\mathrm m} \cos 2\theta_{\mathrm v}
\end{equation*}
...
Matching of $l_{\mathrm m}$, and $l_{\mathrm k}$?
...
\begin{equation*}
    \mathbf H= -\frac{\omega_{\mathrm{m}}}{2} \boldsymbol{\sigma_3}.
\end{equation*}
...
\begin{tcolorbox}
A. Balantekin, T. Ohlsson, A. Smirnov, E. Akhmedov, et al
\end{tcolorbox}
...
\caption*{Stimulated oscillation. $\delta \lambda(x) = A \sin (\hat k \hat x)$  with $\hat A=0.1$, $\hat k=0.995$, $\theta_{\mathrm{m}}=\pi/6$}
\end{figure}
...
\begin{tcolorbox}[title=Hamiltonian in Background Matter Basis]
    \begin{equation*}
    \mathbf {H_0} = \frac{1}{2}\left( - \omega_{\mathrm{m}} + {\color{red}\delta \lambda(x)} \cos 2\theta_{\mathrm{m}} \right) \boldsymbol{\sigma_3} - \frac{  {\color{red}\delta \lambda(x)}  }{2} \sin \theta_{\mathrm{m}} \boldsymbol{\sigma_1}.
\end{equation*}
\end{tcolorbox}
...
\begin{equation*}
    \mathbf{\widetilde H} = - \frac{ {\color{red}\delta \lambda(x)}  }{2} \sin 2\theta_{\mathrm{m}} \begin{pmatrix} 0 & e^{2i\eta(x)} \\ e^{-2 i\eta(x) } & 0 \end{pmatrix} 
\end{equation*} 
...
\begin{equation*}
    ...
    0 & e^{i(k x + 2{\color{violet}\eta})} - e^{i(-k x + 2{\color{violet}\eta})} \\
    e^{i(k x - 2{\color{violet}\eta})} - e^{i(-k x - 2{\color{violet}\eta})} & 0
    \end{pmatrix}
\end{equation*}

\begin{equation*}
    {\color{violet}\eta(x)} = - \frac{\omega_{\mathrm m} }{2}x - \frac{\cos 2\theta_{\mathrm m} }{2} \frac{A}{k} \cos (k x ).
\end{equation*}
...
\begin{equation*}
    h = \frac{i}{4}\left( e^{i(k + \omega_{\mathrm m})x + i\cos 2\theta_{\mathrm m} \frac{A}{k} \cos (k x ) } - e^{i(-k  + \omega_{\mathrm m})x + i\cos 2\theta_{\mathrm m} \frac{A}{k} \cos (k x ) } \right)
\end{equation*}
...
\begin{equation*}
h\propto e^{i(k + \omega_{\mathrm m})x + i\cos 2\theta_{\mathrm m} \frac{A}{k} \cos (k x ) } - e^{i(-k  + \omega_{\mathrm m})x + i\cos 2\theta_{\mathrm m} \frac{A}{k} \cos (k x ) },
\end{equation*}
...
\centering
small ${\color{magenta} (n\hat k-1)}$ $\to$ important term
...
\begin{figure}
    ...
    \caption*{RWA works. $\hat A=0.1$, $\hat k=0.995$, $\theta_{\mathrm{m}}=\pi/6$}
\end{figure}
...
\item 
Mass squared differences + mixing angles $\to$ Vacuum oscillations
\item 
Matter oscillations depend on matter profile
\item
Single frequency periodic matter profile $\to$ Resonances and their width
