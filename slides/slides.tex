...
\begin{equation*}
    \mathbf{\tilde H} = - \frac{ {\color{red}\delta \lambda(x)}  }{2} \sin 2\theta_m \begin{pmatrix} 0 & e^{2i\eta(x)} \\ e^{-2 i\eta(x) } & 0 \end{pmatrix} 
\end{equation*} 
...
\item 
Mass squared differences + mixing angles -> Vacuum oscillation
\item 
Matter oscillations depend on matter profile
\item
Single frequency periodic matter profile -> Resonances and their width
