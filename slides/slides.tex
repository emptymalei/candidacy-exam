...
\begin{itemize}
    ...
    \item Mixing angle determines flavor oscillation amplitude
\end{itemize}
...
\begin{equation*}
    \frac{\omega_{\mathrm{v}} \cos 2\theta_{\mathrm{v}} }{2} \boldsymbol{\sigma_3} + \frac{ \omega_{\mathrm{v}} \sin 2\theta_{\mathrm{v}}}{2} \boldsymbol{\sigma_1}
\end{equation*}
