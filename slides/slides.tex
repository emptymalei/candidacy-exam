...
\section{Stimulated Neutrino Oscillations}
...
\begin{frame}{Stimulated Neutrino Oscillations: Math}

\begin{tcolorbox}[title=A Better Basis to Work in?]

Remove the position dependence of the diagonalized part of the Hamiltonian!

New basis where the wave function $(\psi_{p1},\psi_{p2})^T$ is related to the wave function in background matter basis
